...
class TestBulkUploadResponse:
    ...
    def test_create_bulk_upload_response(self):
        ...
        response = BulkUploadResponse(
            ...
            failed_uploads=1,
            results=[
                {"filename": "resume1.pdf", "status": "success", "document_id": str(uuid4())},
                {"filename": "resume2.pdf", "status": "success", "document_id": str(uuid4())},
                {"filename": "resume3.pdf", "status": "success", "document_id": str(uuid4())},
                {"filename": "resume4.pdf", "status": "success", "document_id": str(uuid4())},
                {"filename": "resume5.pdf", "status": "failed", "error": "File too large"},
            ]
        )
...
class TestDocumentUpdateResponse:
    ...
    def test_create_update_response(self):
        ...
        response = DocumentUpdateResponse(
            success=True,
            data={"document_id": str(uuid4()), "updated_fields": ["text_content", "role"]},
